    ...
    <DropdownMenu.Portal>
      <DropdownMenu.Content
        ...
        className={cn(
          ...
          "max-sm:max-h-[min(70dvh,28rem)] max-sm:overflow-y-auto max-sm:rounded-2xl max-sm:border max-sm:border-border max-sm:p-2 max-sm:shadow-elevated",
  ...
  <>
    ...
    <DropdownMenu.SubContent
      ...
      className={cn(
        ...
        "max-sm:!fixed max-sm:!inset-x-3 max-sm:!bottom-3 max-sm:!top-auto max-sm:!left-3 max-sm:!right-3",
        "max-sm:!w-auto max-sm:!min-w-0 max-sm:!max-w-none max-sm:!transform-none",
        "max-sm:max-h-[min(70dvh,28rem)] max-sm:overflow-y-auto max-sm:rounded-2xl max-sm:p-2 max-sm:shadow-elevated",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        "max-sm:data-[state=closed]:slide-out-to-bottom max-sm:data-[state=open]:slide-in-from-bottom",

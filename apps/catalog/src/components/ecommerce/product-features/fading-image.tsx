    ...
    <section className="w-full bg-white">
      ...
      <div className="grid gap-4 px-6 py-8 sm:grid-cols-3 sm:px-8">
        <div className="rounded-2xl border border-ground-100 bg-white p-5">
          <p className="label text-ground-400">Material</p>
          <p className="subheading mt-2 text-ground-900">Ballistic nylon</p>
          <p className="body mt-2 text-ground-600">
            Structured enough to hold shape, soft enough for daily wear.
          </p>
        </div>
        <div className="rounded-2xl border border-ground-100 bg-white p-5">
          <p className="label text-ground-400">Dimensions</p>
          <p className="subheading mt-2 text-ground-900">{`15"×10"×3"`}</p>
          <p className="body mt-2 text-ground-600">
            A compact footprint designed for light essentials.
          </p>
        </div>
        <div className="rounded-2xl border border-ground-100 bg-white p-5">
          <p className="label text-ground-400">Warranty</p>
          <p className="subheading mt-2 text-ground-900">Lifetime</p>
          <p className="body mt-2 text-ground-600">

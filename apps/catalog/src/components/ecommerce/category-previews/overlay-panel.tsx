  ...
  return (
    <section className="w-full overflow-hidden rounded-[32px] bg-ground-900 lg:grid lg:grid-cols-[1.5fr_1fr]">
      <div className="min-h-[360px]">
        <CategoryImage src={EDITION_ONE} alt="Travel category" className="min-h-[360px]" />
      </div>
      <div className="flex flex-col justify-center bg-ground-900 p-8 text-white sm:p-10">
        ...
        <p className="body mt-4 text-white/75">
          Packable layers, modular organizers, and smart carry pieces built to stay calm while the
          rest of the day keeps moving.
        </p>
        <div className="mt-6">

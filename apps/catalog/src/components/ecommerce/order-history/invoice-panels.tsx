  ...
  return (
    <div className="w-full bg-white p-6">
      <div className="grid gap-6 lg:grid-cols-2">
        {ORDERS.map((order) => (
          <div key={order.id} className="rounded-[32px] border border-taupe-200 bg-white p-6 shadow-natural">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="label text-taupe-400">Order number</p>
                <h3 className="heading mt-2 text-taupe-900">{order.id}</h3>
                <p className="caption mt-1 text-taupe-500">{order.date}</p>
              </div>
              <StatusBadge status={order.status} />
            </div>
            <div className="mt-6 space-y-4 border-y border-taupe-100 py-6">
            ...
            <div className="mt-6 flex items-center justify-between">
              <div>
                <p className="caption text-taupe-400">Order total</p>

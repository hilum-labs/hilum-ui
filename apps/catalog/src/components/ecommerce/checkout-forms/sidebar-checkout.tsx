...
export default function SidebarCheckout() {
  return (
    <div className="w-full bg-white p-6">
      <div className="overflow-hidden rounded-[32px] border border-taupe-200 bg-taupe-50 shadow-natural lg:grid lg:grid-cols-[1fr_360px]">
        <div className="bg-white p-8">
          <div className="mb-8 flex items-center justify-between">
            <div>
              <p className="label text-taupe-400">Fast checkout</p>
              <h3 className="heading mt-2 text-taupe-900">Shipping and payment</h3>
            </div>
        ...
        <OrderSummary detailed className="h-full rounded-none border-0 bg-taupe-50 shadow-none" />
      </div>
    </div>
  );
}

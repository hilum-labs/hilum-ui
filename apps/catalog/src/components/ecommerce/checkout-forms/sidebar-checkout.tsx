...
export default function SidebarCheckout() {
  return (
    <div className="w-full bg-white p-6">
      <div className="overflow-hidden rounded-[32px] border border-ground-200 bg-ground-50 shadow-natural lg:grid lg:grid-cols-[1fr_360px]">
        <div className="bg-white p-8">
          <div className="mb-8 flex items-center justify-between">
            <div>
              <p className="label text-ground-400">Fast checkout</p>
              <h3 className="heading mt-2 text-ground-900">Shipping and payment</h3>
            </div>
            <Badge variant="warning">Guest checkout</Badge>
          </div>
          <div className="space-y-6">
            <FormSection title="Contact information" description="Order updates arrive here first.">
              <ContactFields prefix="sidebar-contact" />
            </FormSection>
            <FormSection title="Shipping address" description="Choose a destination for this order.">
              <ShippingFields prefix="sidebar-shipping" />
            </FormSection>
            <FormSection title="Payment" description="Visa, Mastercard, and Amex accepted.">
              <PaymentFields prefix="sidebar-payment" />
            </FormSection>
            <Button className="w-full sm:w-auto">Place order</Button>
          </div>
        </div>
        <OrderSummary detailed className="h-full rounded-none border-0 bg-ground-50 shadow-none" />
      </div>
    </div>
  );
}

  ...
  return (
    <div className="w-full bg-taupe-50 p-6">
      <div className="rounded-[32px] border border-taupe-200 bg-white p-8 shadow-natural">
        <div className="mb-8">
          <p className="label text-taupe-400">Single step</p>
          <h3 className="heading mt-2 text-taupe-900">Everything in one pass</h3>
        </div>
        ...
        <div className="mt-6">
          <OrderSummary compact className="bg-taupe-50" />
        </div>
        <div className="mt-6 flex items-center justify-between gap-4">
          <p className="caption text-taupe-500">By placing the order you agree to the store terms and return policy.</p>

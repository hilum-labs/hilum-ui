    ...
    <section className="w-full bg-white px-6 py-8 md:px-8">
      <div className="grid gap-8 lg:grid-cols-2">
        <div className="order-2 lg:order-1">
          <ProductHeader />
          <p className="body mt-6 max-w-xl text-taupe-500">{PRODUCT_DESCRIPTION}</p>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-brand-secondary/20 px-3 py-1.5 caption text-taupe-800">
              <Check className="size-4" />
              In stock and ready to ship
            </div>
          </div>
        </div>
        <div className="order-1 rounded-[2rem] bg-taupe-50 p-8 lg:order-2">

  ...
  return (
    <div className="grid min-h-[340px] w-full overflow-hidden rounded-xl bg-ground-50 md:grid-cols-[1fr_0.9fr]">
      <div className="relative h-[320px] px-8 py-8">
        <Tile
          src={images.tile3}
          alt="Minimal accessories"
          className="absolute left-12 top-6 h-48 w-48 rotate-[-6deg]"
        />
        <Tile
          src={images.main}
          alt="Desk organizer"
          className="absolute left-32 top-20 h-52 w-56 rotate-[5deg]"
        />
        <Tile
          src={images.tile2}
          alt="Desk lighting"
          className="absolute left-4 bottom-4 h-36 w-40 rotate-[7deg]"
        />
      </div>
      <div className="flex items-center px-8 py-10 md:px-10">
        <div className="max-w-md">
          ...
          <p className="body mt-3 text-ground-500">
            Mix natural finishes, warm metal accents, and practical storage to bring order to the
            day.
          </p>

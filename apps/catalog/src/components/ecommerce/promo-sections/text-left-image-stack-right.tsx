  ...
  return (
    <div className="grid min-h-[360px] w-full overflow-hidden rounded-xl bg-gradient-to-br from-brand-secondary/40 via-white to-brand-secondary/20 md:grid-cols-[0.95fr_1.05fr]">
      ...
      <div className="relative h-[320px] px-8 py-8">
        <Tile src={images.tile1} alt="Desk shelf" className="absolute left-8 top-10 h-44 w-40 rotate-[-8deg]" />
        <Tile src={images.tile2} alt="Desk lamp" className="absolute right-14 top-2 h-56 w-48 rotate-[8deg]" />
        <Tile src={images.tile3} alt="Desk accessories" className="absolute right-8 bottom-4 h-40 w-44 rotate-[-4deg]" />
      </div>
    </div>
  );
}

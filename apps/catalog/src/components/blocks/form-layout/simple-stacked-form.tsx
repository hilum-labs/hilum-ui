  ...
  return (
    <form className="flex flex-col gap-5 w-full max-w-md" onSubmit={(e) => e.preventDefault()}>
      <div className="grid grid-cols-2 gap-3">
        <Field label="First name" htmlFor="ss-fn">
          <Input id="ss-fn" placeholder="Jane" />
        </Field>
        <Field label="Last name" htmlFor="ss-ln">
          <Input id="ss-ln" placeholder="Smith" />
        </Field>
      </div>

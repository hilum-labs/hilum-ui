  ...
  return (
    <div className="mx-auto w-full max-w-sm">
      <div className="mb-8 text-center">
        ...
        <h1 className="heading text-taupe-900">Sign in to your account</h1>
      ...
      <div className="rounded-xl border border-taupe-100 bg-white p-6 shadow-natural">
        ...
        <div className="my-5 flex items-center gap-3">
          ...
          <span className="caption text-taupe-400">Or continue with</span>
          <Separator className="flex-1" />
        </div>
      ...
      <p className="mt-6 text-center caption text-taupe-400">
        Don&apos;t have an account?{" "}
        <a href="#" className="font-semibold text-taupe-900 hover:underline">
          Sign up
        </a>
      </p>
    </div>

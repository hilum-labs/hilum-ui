        ...
        <div>
          ...
          <div className="mt-8 space-y-4">
            {POSTS.slice(0, 2).map((post) => (
              <article
                key={post.title}
                className="rounded-2xl border border-ground-100 bg-white p-6 shadow-sm"
              >
                ...
                <div className="mt-5 flex items-center justify-between gap-4 border-t border-ground-100 pt-5">
        ...
        <aside className="rounded-2xl bg-ground-50 p-8">
          ...
          <div className="mt-8 space-y-3">
            <input
              ...
              className="h-9 w-full rounded-lg border border-ground-200 bg-white px-3 body text-ground-900 placeholder:text-ground-400 focus:outline-none focus:ring-2 focus:ring-brand-primary/30 focus:border-brand-primary"
            />
            <Button className="w-full">Subscribe</Button>
          </div>
          <div className="mt-8 rounded-2xl border border-ground-200 bg-white p-5">
            <p className="label text-ground-400">Also included</p>
            <ul className="mt-4 space-y-3">
              <li className="body text-ground-700">Monthly component release notes</li>
              <li className="body text-ground-700">Early previews of upcoming patterns</li>
              <li className="body text-ground-700">Notes from our design reviews</li>
            </ul>
          </div>
        </aside>
      </div>

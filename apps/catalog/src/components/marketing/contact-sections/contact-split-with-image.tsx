...
export default function ContactSplitWithImage() {
  return (
    <section className="grid w-full lg:grid-cols-2">
      <div className="relative min-h-[520px] bg-taupe-100">
        ...
        <div className="absolute bottom-8 left-8 rounded-2xl bg-white/80 p-5 backdrop-blur">
          <p className="label text-taupe-400">Studio visit</p>
          <p className="subheading mt-2 text-taupe-900">New York HQ</p>
          <p className="body mt-2 text-taupe-500">Meet the product, design, and engineering leads in one place.</p>
        </div>
      </div>
      <div className="bg-white px-8 py-14">
        <div className="mx-auto max-w-xl">
          <p className="label text-brand-primary">Book a consultation</p>
          <h2 className="heading mt-4 text-taupe-900">Tell us where your team is stuck</h2>

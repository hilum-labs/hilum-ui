  ...
  return (
    <section className="w-full bg-white px-6 py-16 sm:px-10">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h3 className="display mt-4 text-taupe-900">
          A point of view that helps teams ship better work
        </h3>
        <p className="body mt-6 text-taupe-600">
        ...
        <hr className="my-10 border-taupe-100" />
        <div className="grid gap-4 sm:grid-cols-3">
          <div>
            <p className="display text-brand-primary">84%</p>
            <p className="body mt-1 text-taupe-600">faster page assembly</p>
          </div>
          <div>
            <p className="display text-brand-primary">3x</p>
            <p className="body mt-1 text-taupe-600">more reusable patterns</p>
          </div>
          <div>
            <p className="display text-brand-primary">12d</p>
            <p className="body mt-1 text-taupe-600">saved each quarter</p>
          </div>
        </div>
      </div>
    </section>

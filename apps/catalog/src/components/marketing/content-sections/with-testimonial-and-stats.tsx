  ...
  return (
    <section className="w-full bg-white px-6 py-16 sm:px-10">
      <div className="max-w-2xl">
        <p className="label mb-4 uppercase tracking-wide text-brand-primary">Outcomes</p>
        <h3 className="heading text-ground-900">A system that helps teams align quickly</h3>
        <p className="body mt-4 text-ground-600">
          Pair qualitative proof with quantitative proof. This layout gives the customer story room
          to breathe while keeping the business impact visible.
        </p>
      </div>
      <div className="mt-10 lg:grid lg:grid-cols-[1fr_0.95fr] lg:gap-10">
        <aside className="rounded-2xl border border-ground-100 bg-ground-50 p-8">
          ...
          <p className="heading mt-8 leading-tight text-ground-900">
            &ldquo;The library gave our team a common starting point, but the real win was how
            quickly product and marketing began speaking the same language.&rdquo;
          </p>
        </aside>

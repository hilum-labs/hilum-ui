      ...
      <div className="flex items-center justify-between border-b border-taupe-100 px-6 py-4">
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-6">
            <a href="#solutions" className="body text-taupe-500 hover:text-taupe-900">
              Solutions
            </a>
            <div className="relative">
              ...
              {open ? (
                <div className="absolute left-1/2 z-10 mt-3 w-80 -translate-x-1/2 rounded-xl border border-taupe-100 bg-white p-2 shadow-elevated ring-1 ring-taupe-100/50">
                  {STACKED_ITEMS.map((item) => (
                    <FlyoutLink key={item.name} item={item} />
                  ))}
                  <div className="mt-2 border-t border-taupe-100 px-3 pt-3">
                    <div className="flex items-center justify-between gap-4">
                      {[
                        ...
                        <a
                          key={link.label}
                          href={link.href}
                          className="inline-flex items-center gap-1.5 caption font-medium text-taupe-600 transition-colors hover:text-taupe-900"
                        >
                          {link.label}

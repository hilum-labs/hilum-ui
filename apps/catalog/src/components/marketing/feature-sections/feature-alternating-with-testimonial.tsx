...
export default function FeatureAlternatingWithTestimonial() {
  const sections = [
    ...
    },
    {
      ...
      imageTheme: "from-brand-secondary/20 via-white to-ground-100",
      imageFirst: false,
    },
  ];
        ...
        {sections.map((item) => (
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              <p className="label text-ground-400">{item.eyebrow}</p>
                ...
                <div className="flex h-full flex-col gap-4 rounded-[1.25rem] bg-white/70 p-6 shadow-natural ring-1 ring-inset ring-white/[0.035] backdrop-blur">
                  ...
                  <div className="grid flex-1 gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl bg-white px-4 py-4 shadow-natural">
                      <p className="caption text-ground-400">Tasks completed</p>
                      <p className="subheading text-ground-900">126 of 132</p>
                    </div>
                    <div className="rounded-2xl bg-white px-4 py-4 shadow-natural">
                      <p className="caption text-ground-400">Stakeholder replies</p>
                      <p className="subheading text-ground-900">2 pending</p>
                    </div>
                  </div>
                </div>
              </div>

  ...
  const features = [
    {
      ...
      description: "Spin up region-ready pages with shared brand controls and local market flexibility.",
    },
    {
      icon: Shield,
      name: "Approval routing",
      description: "Automate legal, security, and editorial sign-off before anything reaches production.",
    },
    {
      icon: Layers,
      name: "Reusable sections",
      description: "Build a library of tested components that keeps every launch on-brand and consistent.",
    },
    {
      icon: RefreshCw,
      name: "Always current",
      description: "Refresh messaging, screenshots, and proof points across your site in a single update.",
    },
  ];

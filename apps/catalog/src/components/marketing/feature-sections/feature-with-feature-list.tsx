  ...
  return (
    <section className="w-full bg-white px-8 py-16 md:px-12">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-center">
        <div className="relative h-96 overflow-hidden rounded-[2rem] bg-taupe-100 p-8">
          ...
          <div className="relative flex h-full flex-col justify-between rounded-[1.5rem] border border-white/60 bg-white/60 p-6 shadow-natural backdrop-blur">
            <div>
              <p className="label text-taupe-400">Customer workspace</p>
              <div className="mt-4 grid gap-3">
                <div className="rounded-2xl bg-white px-4 py-3 shadow-natural">
                  <p className="caption text-taupe-400">Renewal confidence</p>
                  <p className="subheading text-taupe-900">92% on-track</p>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="rounded-2xl bg-white px-4 py-3 shadow-natural">
                    <p className="caption text-taupe-400">Product adoption</p>
                    <p className="subheading text-taupe-900">68% MAU</p>
                  </div>
                  <div className="rounded-2xl bg-white px-4 py-3 shadow-natural">
                    <p className="caption text-taupe-400">Open blockers</p>
                    <p className="subheading text-taupe-900">3 items</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="rounded-2xl border border-white/70 bg-white/70 px-4 py-3">
              <p className="caption text-taupe-400">Latest update</p>
              <p className="body mt-1 text-taupe-700">Implementation completed ahead of schedule for APAC rollout.</p>
            </div>
          </div>
        </div>
        <div className="max-w-xl">
          <Badge variant="secondary" className="mb-4">Customer visibility</Badge>
          <h3 className="heading text-taupe-900">See the entire customer story in one place</h3>
          ...
          <div className="mt-8 space-y-4">
            {items.map((item) => (
              <div key={item} className="flex items-start gap-3">
                ...
                <p className="body text-taupe-600">{item}</p>
              </div>
            ))}
          </div>
          <div className="mt-8">

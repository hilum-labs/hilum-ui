  ...
  const features = [
    {
      ...
      name: "Smart briefs",
      description:
        "Kick off every project with pre-filled goals, channels, owners, and success criteria.",
    },
    {
      icon: BarChart2,
      name: "Forecasting",
      description:
        "See launch impact before campaigns go live with benchmarks tied to historical performance.",
    },
    {
      icon: Globe,
      name: "Regional visibility",
      description:
        "Surface blockers, approvals, and publication status across every country rollout.",
    },
    {
      icon: Shield,
      name: "Compliance checks",
      description:
        "Catch missing approvals and policy violations before launch windows are at risk.",
    },
    {
      icon: Layers,
      name: "Shared building blocks",
      description:
        "Reuse the same approved modules across product pages, emails, and campaign landers.",
    },
    {
      icon: RefreshCw,
      name: "Operational cadence",
      description:
        "Create a predictable launch rhythm with reminders, recurring reviews, and version history.",
    },
  ];
      ...
      <div className="mx-auto max-w-6xl">
        <div className="max-w-2xl">
          ...
          <p className="body mt-3 text-ground-500">
            Turn scattered checklists and one-off spreadsheets into a reliable operating system for
            your entire launch calendar.
          </p>
        </div>

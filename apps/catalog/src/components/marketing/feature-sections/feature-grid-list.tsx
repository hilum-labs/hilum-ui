  ...
  return (
    <section className="w-full bg-white px-8 py-16 md:px-12">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.95fr_1.35fr]">
        <div className="rounded-[2rem] bg-taupe-900 p-8 text-white shadow-elevated">
          ...
          <div className="mt-10 rounded-[1.5rem] border border-white/10 bg-white/5 p-6">
            <p className="caption text-taupe-400">Average launch prep time</p>
            <p className="mt-3 text-6xl font-semibold tracking-tight text-brand-secondary">3.2x</p>
            <p className="body mt-3 text-taupe-300">faster than teams managing work across docs, tickets, and ad hoc review threads.</p>
          </div>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <article key={feature.name} className="rounded-[1.5rem] border border-taupe-100 bg-taupe-50 p-5">

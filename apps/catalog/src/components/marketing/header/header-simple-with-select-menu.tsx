  ...
  return (
    <section className="w-full bg-white px-8 py-16">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h2 className="display mt-4 text-taupe-900">Patterns for every page state</h2>
        ...
        <div className="mt-8 inline-flex flex-wrap items-center justify-center gap-2 rounded-full bg-taupe-100 p-1">
          {TABS.map((tab) => (
            <button
              key={tab}

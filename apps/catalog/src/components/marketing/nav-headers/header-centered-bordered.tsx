...
export default function HeaderCenteredBordered() {
  ...
  return (
    <div className="relative min-h-[16rem] w-full bg-white">
      <header className="border-b border-ground-200 bg-white">
        ...
        <div className="hidden items-center justify-center gap-8 border-t border-ground-100 px-6 py-4 md:flex">
          {NAV_LINKS.map((link) => (
            <a
              key={link}

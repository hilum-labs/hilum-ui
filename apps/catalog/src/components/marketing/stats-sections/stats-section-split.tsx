  ...
  return (
    <section className="w-full overflow-hidden bg-white">
      <div className="grid md:grid-cols-2">
        <div className="flex min-h-[340px] items-center justify-center bg-taupe-100 p-10">
          <div className="aspect-video w-full max-w-xl rounded-2xl bg-taupe-200 shadow-natural" />
        </div>

        <div className="px-8 py-16 md:px-12">
          <Badge variant="outline">Performance snapshot</Badge>
          <h2 className="heading mt-4 text-taupe-900">Trusted by teams worldwide</h2>
          <p className="body mt-3 max-w-lg text-taupe-500">
          ...
          <dl className="mt-10 grid gap-6 sm:grid-cols-2">
            <StatGrid
              ...
              labelClassName="body mt-2 text-taupe-500"
            />
          </dl>
        </div>
      </div>

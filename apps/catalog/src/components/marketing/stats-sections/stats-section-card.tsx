  ...
  return (
    <section className="w-full bg-white px-8 py-16 text-center">
      <div className="mx-auto max-w-5xl">
        <h2 className="heading text-taupe-900">Trusted by teams worldwide</h2>
        ...
        <div className="shadow-elevated mt-10 overflow-hidden rounded-xl bg-white">
          <dl className="grid divide-y divide-taupe-100 md:grid-cols-4 md:divide-x md:divide-y-0">
            <StatGrid
              valueClassName="display px-6 pt-8 font-bold text-brand-primary"
              labelClassName="body px-6 pb-8 pt-2 text-taupe-500"
            />
          </dl>
        </div>
      </div>

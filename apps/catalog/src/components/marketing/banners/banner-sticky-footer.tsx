...
export default function BannerStickyFooter() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl border border-taupe-100 bg-white shadow-natural" style={{ height: 240 }}>
      <div className="flex h-full items-center justify-center">
        <p className="body text-taupe-400">Page content</p>
      </div>
      {visible && (
        <div className="absolute inset-x-0 bottom-0 flex flex-col items-center justify-between gap-3 border-t border-taupe-100 bg-white px-5 py-3 sm:flex-row">

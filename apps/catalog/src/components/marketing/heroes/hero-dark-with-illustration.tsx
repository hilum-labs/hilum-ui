...
export default function HeroDarkWithIllustration() {
  return (
    <section className="w-full bg-ground-900 px-6 py-24 text-white sm:px-10 lg:px-14">
      <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="rounded-[2rem] border border-ground-800 bg-ground-950 p-6 shadow-elevated">
          <div className="grid gap-4">
            <div className="rounded-2xl border border-ground-800 bg-ground-900/80 p-5">
              <p className="caption text-ground-400">Workflow health</p>
              <div className="mt-4 flex items-end justify-between">
                <p className="heading text-white">Stable</p>
                <span className="rounded-full bg-brand-secondary px-3 py-1 label text-ground-950">
                  14 blockers cleared
                </span>
              </div>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={item}
                  className="rounded-2xl border border-ground-800 bg-ground-900/70 p-4"
                >
                  <div className="flex items-start gap-3">
                    <div className="mt-0.5 flex size-6 items-center justify-center rounded-full bg-brand-primary">
                      <Check className="size-3.5 text-white" />
                    </div>
                    <p className="body text-ground-200">{item}</p>
                  </div>
                </div>
              ))}
            </div>

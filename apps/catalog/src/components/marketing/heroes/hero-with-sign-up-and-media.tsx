...
export default function HeroWithSignUpAndMedia() {
  return (
    <section className="w-full bg-taupe-50 px-6 py-20 sm:px-10 lg:px-14">
      <div className="mx-auto max-w-5xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <form className="mt-8 flex flex-col gap-3 sm:flex-row">
            <input
              ...
              className="h-11 flex-1 rounded-md border border-taupe-200 bg-white px-3 body text-taupe-900 outline-none placeholder:text-taupe-400 focus:border-taupe-300"
            />
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="rounded-[1.75rem] bg-white p-6 shadow-natural ring-1 ring-taupe-100">
            <p className="caption text-taupe-400">Rollout impact</p>
            <p className="heading mt-3 text-taupe-900">3.4x faster</p>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              {[
                ...
                <div key={label} className="rounded-2xl bg-taupe-50 p-4">
                  <p className="caption text-taupe-400">{label}</p>
                  <p className="subheading mt-2 text-taupe-900">{value}</p>
                </div>
              ))}
            </div>
          </div>

          <div className="rounded-[1.75rem] bg-taupe-900 p-6 text-white shadow-elevated">
            <p className="caption text-taupe-400">What customers say</p>

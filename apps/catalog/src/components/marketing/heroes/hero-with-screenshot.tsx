...
function LogoCloud() {
  return (
    <div className="mt-8 border-y border-taupe-100 bg-taupe-50 px-6 py-4">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-center gap-x-8 gap-y-3 text-taupe-300">
        {LOGOS.map((logo) => (

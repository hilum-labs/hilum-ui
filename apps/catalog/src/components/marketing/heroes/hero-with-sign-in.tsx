    ...
    <section className="w-full bg-taupe-50 px-6 py-20 sm:px-10 lg:px-14">
      <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="max-w-xl">
          ...
          <div className="mt-8 flex items-center gap-3 text-taupe-500">
        ...
        <div className="rounded-[2rem] bg-white p-8 shadow-natural ring-1 ring-taupe-100">
          <div className="mb-6">
            <p className="subheading text-taupe-900">Sign in to Beacon</p>
          ...
          <form className="space-y-4">
            <div className="space-y-2">
              <label className="label uppercase tracking-[0.18em] text-taupe-400">
                Email
              </label>
              <input
                type="email"
                placeholder="team@beacon.so"
                className="h-11 w-full rounded-md border border-taupe-200 bg-white px-3 body text-taupe-900 outline-none placeholder:text-taupe-400 focus:border-taupe-300"
              />
            </div>
            <div className="space-y-2">
              <label className="label uppercase tracking-[0.18em] text-taupe-400">
          ...
          <p className="caption mt-4 text-taupe-400">

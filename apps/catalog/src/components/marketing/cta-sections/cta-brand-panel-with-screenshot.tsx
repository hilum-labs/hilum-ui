...
export default function CTABrandPanelWithScreenshot() {
  return (
    <section className="w-full bg-white px-6 py-16 sm:px-10 lg:px-14">
      <div className="mx-auto grid max-w-6xl overflow-hidden rounded-[2rem] border border-taupe-100 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="bg-taupe-900 p-8 text-white sm:p-10 lg:p-12">
          ...
          <div className="mt-8 space-y-3">
            {[
              ...
              <div key={item} className="flex items-center gap-3 text-taupe-200">
        ...
        <div className="bg-taupe-50 p-8 sm:p-10 lg:p-12">
          <div className="rounded-[1.75rem] bg-white p-5 shadow-natural">
            <div className="mb-5 flex items-center justify-between">
              <div>
                <p className="caption text-taupe-400">Quarterly launch board</p>
                <p className="subheading mt-1 text-taupe-900">
                ...
                const background =
                  index === 0
                    ...
                    : index === 1
                      ? "bg-brand-secondary"
                      : "bg-brand-primary";
                const textColor = index === 2 ? "text-white" : "text-taupe-900";

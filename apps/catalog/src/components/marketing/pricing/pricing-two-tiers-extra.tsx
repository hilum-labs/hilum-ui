    ...
    <section className="w-full bg-white px-8 py-16 md:px-12">
      <div className="mx-auto max-w-5xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h3 className="heading text-taupe-900">Two main choices, with enterprise sales support beneath</h3>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {mainTiers.map((tier) => (
            <article key={tier.name} className="rounded-[2rem] border border-taupe-100 bg-white p-8 shadow-natural">
              ...
              <div className="mt-6 flex items-end gap-2">
                ...
                <p className="body pb-1 text-taupe-400">{tier.name === "Free" ? "" : "/mo"}</p>
              </div>
        ...
        <div className="mt-6 rounded-[2rem] border border-taupe-100 bg-taupe-50 p-8 shadow-natural">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <div className="flex items-center gap-3">
                <h4 className="subheading text-taupe-900">Enterprise</h4>

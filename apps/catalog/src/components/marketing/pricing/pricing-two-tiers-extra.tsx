  ...
  const mainTiers = [
    {
      ...
      price: "$0",
      description:
        "A lightweight way to publish a small number of launch pages and test the workflow.",
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h3 className="heading text-ground-900">
            Two main choices, with enterprise sales support beneath
          </h3>
          <p className="body mt-3 text-ground-500">
            Keep self-serve decisions fast while still making room for larger buyers who need custom
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {mainTiers.map((tier) => (
            <article
              key={tier.name}
              className="rounded-[2rem] border border-ground-100 bg-white p-8 shadow-natural"
            >
        ...
        <div className="mt-6 rounded-[2rem] border border-ground-100 bg-ground-50 p-8 shadow-natural">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="body mt-3 text-ground-500">
                Tailored pricing for organizations that need procurement support, advanced
                governance, and global rollout controls.
              </p>
            </div>

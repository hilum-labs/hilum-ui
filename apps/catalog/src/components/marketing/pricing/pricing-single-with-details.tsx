...
export default function PricingSingleWithDetails() {
  ...
  return (
    <section className="w-full bg-taupe-50 px-8 py-16 md:px-12">
      <div className="mx-auto max-w-4xl rounded-[2rem] border border-taupe-100 bg-white p-8 shadow-natural md:p-10">
        <div className="text-center">
          <Badge variant="brand" className="mb-4">One clear plan</Badge>
          <h3 className="heading text-taupe-900">Everything growing teams need for predictable launches</h3>
          <div className="mt-6 flex items-end justify-center gap-2">
            <p className="text-6xl font-semibold tracking-tight text-taupe-900">$149</p>
        ...
        <div className="my-8 h-px bg-taupe-100" />

    ...
    <div className="w-full px-6 py-8">
      <div className="mx-auto max-w-lg overflow-hidden rounded-xl border border-taupe-200 shadow-lg">
        ...
        <div className="max-h-80 overflow-y-auto bg-white">
          <div className="bg-taupe-50 px-4 py-2 label text-taupe-400">Projects</div>
          {[
            ...
            >
              ...
              <span className="body text-taupe-700">{project.name}</span>
            </button>
          ))}
          <div className="bg-taupe-50 px-4 py-2 label text-taupe-400">People</div>
          {[
            ["Alice Johnson", "AJ"],
            ["Bob Smith", "BS"],
            ["Carol White", "CW"],
            ...
            >
              ...
              <span className="body text-taupe-700">{name}</span>
            </button>
          ))}
          <div className="bg-taupe-50 px-4 py-2 label text-taupe-400">Documents</div>
          {["Q1 Report.pdf", "Brand Guidelines.pdf"].map((document) => (
            ...
            >
              ...
              <span className="body text-taupe-700">{document}</span>
            </button>
          ))}
        </div>
      </div>

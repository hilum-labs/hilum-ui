...
export default function NavbarSimpleDark() {
  ...
  return (
    <div className="rounded-xl border border-taupe-100 overflow-hidden">
      <nav className="relative bg-taupe-900 px-4 py-3 sm:px-5">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            type="button"
            className="flex h-9 w-9 items-center justify-center rounded-full text-taupe-300 transition-colors hover:bg-white/10 hover:text-white md:hidden"
        ...
        {mobileOpen && (
          <div className="absolute inset-x-0 top-full z-10 border-t border-white/10 bg-taupe-900 p-3 shadow-lg md:hidden">

              ...
              <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
                <div>
                  <p className="body text-ground-600">
                    The redesign project is focused on simplifying the marketing site, tightening
                    conversion flows, and aligning content design across product launches.
                  </p>
                ...
                <div className="rounded-xl border border-ground-100 bg-ground-50 p-4">
                  ...
                  <div className="mt-4 space-y-3">
                    {["Audit complete", "Wireframes approved", "Final QA review"].map(
                      (item, index) => (
                        <div key={item} className="flex items-center gap-3">
                          <div
                            className={`flex size-8 items-center justify-center rounded-full ${index < 2 ? "bg-brand-secondary/20 text-ground-900" : "bg-white text-ground-500"}`}
                          >
                          ...
                          <div>
                            ...
                            <p className="caption text-ground-400">
                              {index < 2 ? "Completed" : "Due next week"}
                            </p>
                          </div>
                        </div>
                      ),
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="flex size-10 items-center justify-center rounded-full bg-white text-ground-600">

...
export default function EmptyStateRecommendations() {
  return (
    <div className="w-full bg-white px-6 py-10">
      <div>
        <h3 className="heading text-taupe-900">No data sources connected</h3>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {cards.map((card) => (
            <div
              key={card.title}
              className="cursor-pointer rounded-xl border border-taupe-100 p-5 transition-colors hover:border-taupe-200"
            >
              ...
              <h4 className="body font-semibold text-taupe-900">{card.title}</h4>
              <p className="caption mt-1 text-taupe-500">{card.description}</p>

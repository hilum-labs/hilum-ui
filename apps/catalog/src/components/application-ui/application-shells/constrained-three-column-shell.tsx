...
export default function ConstrainedThreeColumnShell() {
  return (
    <ShellFrame>
      <div className="flex flex-1 bg-taupe-50 p-4">
        <div className="mx-auto flex w-full max-w-7xl overflow-hidden rounded-2xl border border-taupe-100 bg-white">
          <aside className="hidden w-52 border-r border-taupe-100 bg-white lg:flex lg:flex-col">
          ...
          <div className="min-w-0 flex-1 p-6">
            <div className="mb-6 flex items-center justify-between gap-4">
              <div>
                <h3 className="heading text-taupe-900">Planning workspace</h3>
          ...
          <aside className="hidden w-64 border-l border-taupe-100 bg-taupe-50 p-5 xl:block">
            <p className="label text-taupe-400">Context</p>
              ...
              {["Timeline", "Approvals", "Team availability"].map((item) => (
                <div key={item} className="rounded-xl border border-taupe-100 bg-white p-4">
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    <div className="h-2 w-9/12 rounded-full bg-taupe-100" />
                  </div>
                </div>
              ))}
            </div>

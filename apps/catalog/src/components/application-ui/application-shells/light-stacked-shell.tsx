...
export default function LightStackedShell() {
  return (
    <ShellFrame>
      <div className="flex flex-1 flex-col bg-taupe-50">
        <HorizontalNav tone="light" />
        <ContentRows
          title="Quarterly reporting"
          subtitle="A lightweight stacked shell for dashboards, search-heavy pages, and list views."

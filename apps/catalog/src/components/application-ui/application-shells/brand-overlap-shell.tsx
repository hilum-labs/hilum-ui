...
export default function BrandOverlapShell() {
  return (
    <ShellFrame>
      <div className="flex flex-1 flex-col bg-ground-50">
        <HorizontalNav tone="brand" />
        <div className="flex-1 bg-ground-50 px-6 pb-6">
          <div className="-mt-8 rounded-2xl border border-ground-100 bg-white p-6 shadow-natural">
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                <h3 className="heading text-ground-900">Launch planning</h3>

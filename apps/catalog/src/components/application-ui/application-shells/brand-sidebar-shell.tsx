...
export default function BrandSidebarShell() {
  return (
    <ShellFrame>
      ...
      <div className="flex min-w-0 flex-1 flex-col bg-white">
        <div className="flex items-center justify-between border-b border-taupe-100 px-5 py-4">
          <div>
            <p className="heading text-taupe-900">Projects</p>
            <p className="caption text-taupe-400">A branded navigation frame for internal product teams.</p>
          </div>
          <Button size="sm">Create Project</Button>
        </div>
        <ContentRows
          title="Delivery board"
          subtitle="The main canvas stays quiet while the brand lives in the sidebar."

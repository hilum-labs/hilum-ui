  ...
  return (
    <div className="bg-white px-8 py-10">
      <div className="grid gap-8">
        <VariantCard title="1. Simple card" className="bg-taupe-50 p-0">
          <div className="mx-auto max-w-sm rounded-3xl border border-taupe-100 bg-white p-8 shadow-elevated">
            ...
            <div className="mb-6 text-center">
              <h3 className="heading text-taupe-900">Sign in to your account</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2">
                  ...
                  />
                  <span className="caption text-taupe-500">Remember me</span>
                </label>
        ...
        <VariantCard title="2. Split screen" className="p-0">
          <div className="overflow-hidden rounded-3xl border border-taupe-100 bg-white shadow-elevated">
            <div className="grid md:grid-cols-2">
              ...
              <div className="px-8 py-10">
                <div className="mb-6">
                  <h3 className="heading text-taupe-900">Welcome back</h3>
                  <p className="caption mt-1 text-taupe-400">

    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        <div className="caption mb-4 flex items-center gap-1.5 text-ground-400">
          ...
          <span>/</span>
          <span className="body font-semibold text-ground-900">Promo Sections</span>
        </div>
        <h1 className="display mb-2 text-ground-900">Promo Sections</h1>
      ...
      <PageDocs path="/ecommerce/promo-sections/" />
...
export const Route = createFileRoute("/ecommerce/promo-sections/")({
  head: () => createCatalogPageHead("/ecommerce/promo-sections/"),
  component: PromoSectionsPage,
});

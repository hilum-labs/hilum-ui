...
function StoreNavigationPage() {
  return (
    <div className="mx-auto max-w-7xl px-8 py-10">
      ...
      <PageDocs path="/ecommerce/store-navigation/" />
...
export const Route = createFileRoute("/ecommerce/store-navigation/")({
  head: () => createCatalogPageHead("/ecommerce/store-navigation/"),
  component: StoreNavigationPage,
});

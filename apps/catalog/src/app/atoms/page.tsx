    ...
    components: [
      {
        name: "Button",
        slug: "button",
        description: "Triggers actions. Supports multiple variants, sizes, and icon compositions.",
        category: "primitive",
      },
      {
        name: "Button Group",
        slug: "button-group",
        description: "Multiple related actions as a unified joined control.",
        category: "primitive",
      },
      {
        name: "Badge",
      ...
      },
      {
        name: "Label",
        slug: "label",
        description: "Accessible form label that associates with its control.",
        category: "primitive",
      },
      {
        name: "Separator",
      ...
      },
      {
        name: "Kbd",
        slug: "kbd",
        description: "Keyboard shortcut display using monospaced styling.",
        category: "primitive",
      },
      {
        name: "Steps",
        slug: "steps",
        description: "Multi-step progress indicator. Circles, bullets, and progress-bar variants.",
        category: "primitive",
      },
      {
        name: "Aspect Ratio",
    ...
    components: [
      {
        name: "Checkbox",
        slug: "checkbox",
        description: "Binary selection control, supports indeterminate state.",
        category: "form",
      },
      {
        name: "Radio Group",
        slug: "radio-group",
        description: "Single selection from a set of mutually exclusive options.",
        category: "form",
      },
      {
        name: "Switch",
      ...
      },
      {
        name: "Toggle",
        slug: "toggle",
        description: "Two-state press button for toolbars and filter controls.",
        category: "form",
      },
      {
        name: "Toggle Group",
      ...
      },
      {
        name: "Select",
        slug: "select",
        description: "Dropdown list for choosing a single option.",
        category: "form",
      },
      {
        name: "Native Select",
      ...
      },
      {
        name: "Combobox",
        slug: "combobox",
        description: "Searchable select field with autocomplete filtering.",
        category: "form",
      },
      {
        name: "Command",
      ...
      },
      {
        name: "Calendar",
        slug: "calendar",
        description: "Date picker calendar with single, range, and multi-select modes.",
        category: "form",
      },
      {
        name: "Date Picker",
        slug: "date-picker",
        description: "Composable date input combining calendar with a popover trigger.",
        category: "form",
      },
      {
        name: "Input OTP",
  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        name: "Alert Dialog",
        slug: "alert-dialog",
        description: "Confirmation modal that requires explicit user action before proceeding.",
        category: "overlay",
      },
      {
        name: "Sheet",
        slug: "sheet",
        description: "Slide-in panel anchored to a screen edge.",
        category: "overlay",
      },
      {
        name: "Drawer",
        slug: "drawer",
        description: "Bottom sheet that slides up from the edge, optimised for mobile.",
        category: "overlay",
      },
      {
        name: "Tooltip",
        slug: "tooltip",
        description: "Brief label that appears on hover to clarify an element.",
        category: "overlay",
      },
      {
        name: "Popover",
        slug: "popover",
        description: "Floating panel anchored to a trigger, for richer content.",
        category: "overlay",
      },
      {
        name: "Hover Card",
        slug: "hover-card",
        description: "Rich preview card that appears on hover over a link or element.",
        category: "overlay",
      },
      {
        name: "Dropdown Menu",
        slug: "dropdown-menu",
        description: "Contextual menu revealed on trigger interaction.",
        category: "overlay",
      },
      {
        name: "Context Menu",
        slug: "context-menu",
        description: "Right-click menu with nested sub-menus and keyboard support.",
        category: "overlay",
      },
    ],
  },
    ...
    components: [
      {
        name: "Menubar",
        slug: "menubar",
        description: "Horizontal application menu bar with nested dropdown panels.",
        category: "layout",
      },
      {
        name: "Navigation Menu",
        slug: "navigation-menu",
        description: "Accessible top-level navigation with animated dropdown panels.",
        category: "layout",
      },
      {
        name: "Sidebar",
        slug: "sidebar",
        description: "Composable side navigation with collapsible, icon, and off-canvas modes.",
        category: "layout",
      },
    ],
  },
  {
    ...
    components: [
      ...
      },
      {
        name: "Collapsible",
        slug: "collapsible",
        description: "Toggleable content region, building block for nav groups.",
        category: "layout",
      },
      {
        name: "Scroll Area",
        slug: "scroll-area",
        description: "Scrollable container with a styled custom scrollbar.",
        category: "layout",
      },
      {
        name: "Breadcrumb",
      ...
      },
      {
        name: "Carousel",
        slug: "carousel",
        description: "Horizontally scrollable item sequence with previous/next controls.",
        category: "layout",
      },
      {
        name: "Resizable",
        slug: "resizable",
        description: "Drag-to-resize panel groups for flexible layouts.",
        category: "layout",
      },
    ],
  },
  {
    ...
    components: [
      ...
      },
      {
        name: "Data Table",
        slug: "data-table",
        description: "Sortable, filterable table powered by TanStack Table.",
        category: "data",
      },
      {
        name: "Chart",
        slug: "chart",
        description: "Recharts-based data visualisation with design-system styling.",
        category: "data",
      },
    ],
  },
  {
    ...
    components: [
      ...
      },
      {
        name: "Toast",
        slug: "sonner",
        description: "Non-blocking notifications that appear briefly and dismiss automatically.",
        category: "feedback",
      },
    ],
  },
    ...
    components: [
      {
        ...
        slug: "color-picker",
        description:
          "Popover color selector with native color wheel, hex input, and optional preset palette.",
        category: "form",
      },
      {
        name: "Color Input",
        slug: "color-input",
        description:
          "Compact inline color input combining swatch, hex field, and optional opacity control.",
        category: "form",
      },
      {
        name: "Input Number",
        slug: "input-number",
        description:
          "Numeric input with steppers, unit suffix, and arrow-key stepping. Designed for inspector panels.",
        category: "form",
      },
    ],
  },

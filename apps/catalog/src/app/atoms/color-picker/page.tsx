...
const PRESETS = ["#c100f1", "#ff6b6b", "#4ecdc4", "#45b7d1", "#96ceb4", "#ffeaa7", "#a29bfe", "#fd79a8"];
    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        ...
        <p className="body max-w-lg text-ground-500">
          Popover-based color selector with a native color wheel, hex input, and optional preset palette.
          Designed for designer property panels.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <PreviewBlock title="Basic" description="Color swatch trigger opening a popover" code={CODE.basic}>
          <ColorPicker value={color} onChange={setColor} ariaLabel="Pick a color" />
        </PreviewBlock>

        <PreviewBlock title="With presets" description="Preset palette shown above the color wheel" code={CODE.withPresets}>
          <ColorPicker

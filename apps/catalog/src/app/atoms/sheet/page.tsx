  ...
  return (
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        ...
        <p className="body max-w-lg text-ground-500">Slide-in panel anchored to a screen edge.</p>
      </div>
          ...
          <Sheet>
            ...
            <SheetContent>
              ...
              <div className="mt-6 flex flex-col gap-5">
                <div>
                  <Label className="mb-2 block text-xs text-ground-400 uppercase tracking-widest font-semibold">
                    Stability
                  </Label>

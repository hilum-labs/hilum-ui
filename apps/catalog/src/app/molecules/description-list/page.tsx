    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        ...
        <p className="body max-w-md text-ground-400">
          Key–value pairs for displaying structured details. Common in profile pages, settings
          panels, and data cards.
        </p>
      ...
      <div className="flex flex-col gap-10">
        <div>
          ...
          <PreviewBlock
            title="Default"
            description="Term-detail pairs with a header"
            code={CODE.basic}
          >
        ...
        <div>
          ...
          <PreviewBlock
            ...
            description="Each row can carry an action"
        ...
        <div>
          ...
          <PreviewBlock
            ...
            description="For wide panels with many fields"
            code={CODE.twoColumn}
          >

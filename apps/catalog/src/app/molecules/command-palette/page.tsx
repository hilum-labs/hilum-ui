    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        ...
        <p className="body max-w-md text-ground-400">
          A modal search dialog for navigating and executing commands quickly. Items are filtered as
          you type. Groups by category.
        </p>
      ...
      <div className="flex flex-col gap-10">
        <div>
          ...
          <PreviewBlock
            title="Searchable command list"
            description="Grouped by category, filtered as you type"
            code={CODE.basic}
          >

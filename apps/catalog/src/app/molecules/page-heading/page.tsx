    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        ...
        <p className="body max-w-md text-ground-400">
          A full page header with breadcrumb navigation, title, optional description and metadata,
          and action buttons.
        </p>
      ...
      <div className="flex flex-col gap-10">
        <div>
          ...
          <PreviewBlock
            title="Title only"
            description="Minimal form with just a title"
            code={CODE.basic}
          >
        ...
        <div>
          ...
          <PreviewBlock
            ...
            description="Location trail and page-level CTAs"
            code={CODE.withBreadcrumbs}
          >
            <div className="w-full max-w-2xl">
              <PageHeading
                title="Back End Developer"
        ...
        <div>
          ...
          <PreviewBlock
            title="With meta, badge & description"
          ...
          >
            <div className="w-full max-w-2xl">
              <PageHeading
                ...
                breadcrumbs={[{ label: "Jobs", href: "#" }, { label: "Back End Developer" }]}
                meta={[
                  { icon: <Briefcase size={13} />, text: "Full-time" },
                  { icon: <MapPin size={13} />, text: "Remote" },
                  { icon: <Calendar size={13} />, text: "Closes Jan 20" },

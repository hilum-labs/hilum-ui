...
<CardHeading title="Tom Cook" description="Account manager">
  <Avatar size="sm"><AvatarFallback className="bg-brand-secondary text-taupe-900">TC</AvatarFallback></Avatar>
    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        <div className="caption mb-4 flex items-center gap-1.5 text-taupe-400">
          ...
          <span>/</span>
          <span className="body font-semibold text-taupe-900">Card Heading</span>
        </div>
        <h1 className="display mb-2 text-taupe-900">Card Heading</h1>
        ...
        <div className="mt-5 flex items-center gap-4 border-t border-taupe-100 pt-5">
          ...
          <p className="caption text-taupe-400">Card · Avatar · Button · Dropdown Menu</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-10">
        <div>
          ...
          <PreviewBlock title="Title only" description="Used as a card's top border section" code={CODE.simple} previewClassName="items-start p-0">
            <div className="w-full max-w-md rounded-xl border border-taupe-100 overflow-hidden">
              <CardHeading title="Job Postings" />
              <div className="p-5">
                <p className="body text-taupe-400">Card content goes here.</p>
              </div>
            </div>
          </PreviewBlock>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <PreviewBlock title="Avatar + name + email" description="Profile card header" code={CODE.withAvatar} previewClassName="items-start p-0">
              <div className="w-full max-w-sm rounded-xl border border-taupe-100 overflow-hidden">
                <CardHeading title="Tom Cook" description="tom@example.com">
                  <Avatar size="sm">
                    <AvatarFallback className="bg-brand-primary text-white">TC</AvatarFallback>
                  </Avatar>
                ...
                <div className="p-5">
                  <p className="body text-taupe-400">Card content.</p>
                </div>
              </div>
            </PreviewBlock>
            <PreviewBlock title="Avatar + dropdown" description="Card header with contextual menu" code={CODE.withDropdown} previewClassName="items-start p-0">
              <div className="w-full max-w-sm rounded-xl border border-taupe-100 overflow-hidden">
                <CardHeading title="Tom Cook" description="Account manager">
                  <Avatar size="sm">
                    <AvatarFallback className="bg-brand-secondary text-taupe-900">TC</AvatarFallback>
                  </Avatar>
                  <div className="ml-auto">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="ghost" size="sm" className="size-8 p-0 text-taupe-400">

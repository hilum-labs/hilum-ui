...
const PLANS = [
  { value: "starter", label: "Starter", description: "Perfect for small projects", meta: "$9 / month", icon: <Zap size={18} /> },
  { value: "pro", label: "Pro", description: "For growing teams", meta: "$29 / month", icon: <Shield size={18} /> },
  { value: "enterprise", label: "Enterprise", description: "Unlimited everything", meta: "$99 / month", icon: <Globe size={18} /> },
];
    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        <div className="caption mb-4 flex items-center gap-1.5 text-taupe-400">
          ...
          <span>/</span>
          <span className="body font-semibold text-taupe-900">Radio Cards</span>
        </div>
        <h1 className="display mb-2 text-taupe-900">Radio Cards</h1>
        ...
        <div className="mt-5 flex items-center gap-4 border-t border-taupe-100 pt-5">
          ...
          <p className="caption text-taupe-400">Radio Group · Card</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-10">
        <div>
          ...
          <PreviewBlock title="3-column default" description="Label, description, and meta per card" code={CODE.basic} previewClassName="items-start">
        ...
        <div>
          ...
          <PreviewBlock title="Icon + plan details" description="Good for pricing/tier selection" code={CODE.withIcons} previewClassName="items-start">
            <div className="w-full max-w-2xl">
        ...
        <div>
          ...
          <PreviewBlock title="2-column layout" description="Use columns={2} for wider cards" code={CODE.twoCol} previewClassName="items-start">

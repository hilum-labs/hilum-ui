      ...
      <div className="mb-10 flex flex-col gap-6 border-b border-ground-100 pb-6 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <div className="caption mb-4 flex items-center gap-1.5 text-ground-400">
            ...
            <span>/</span>
            <span className="font-semibold text-ground-900">Lists</span>
          </div>
          <h1 className="display mb-2 text-ground-900">Lists</h1>
          <p className="body max-w-2xl text-ground-400">
            Tables, stacked lists, grid lists, and activity feeds.
          </p>
          <p className="caption mt-5 text-ground-400">Data · 34 variants</p>
        </div>
...
export const Route = createFileRoute("/application-ui/lists/")({
  head: () => createCatalogPageHead("/application-ui/lists/"),
  component: ListsPage,
});

  ...
  return (
    <div className="min-h-screen bg-ground-50">
      <div className="mx-auto max-w-7xl px-8 py-10">
        <div className="mb-10">
          <p className="caption mb-2 text-ground-400">Design System / Application UI / Layout</p>
        ...
        <PageDocs path="/application-ui/layout/" />
        ...
        <div className="space-y-10">
          <section>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              ...
              <PreviewBlock
                ...
                code={panelWithHeaderAndFooterSource}
                previewClassName="p-6"
              >
                <PanelWithHeaderAndFooter />
              </PreviewBlock>
              <PreviewBlock
                title="With ground body"
                description="Creates hierarchy by tinting the body region."
                code={panelWithGroundBodySource}
                previewClassName="p-6"
              >
                <PanelWithGroundBody />
              </PreviewBlock>
          ...
          <section>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              ...
              <PreviewBlock
                ...
                code={mediaObjectCenteredSource}
                previewClassName="p-0"
              >
                <MediaObjectCentered />
              </PreviewBlock>
              ...
              <PreviewBlock
                title="Nested"
                description="Media objects can be nested for hierarchy."
                code={mediaObjectNestedSource}
                previewClassName="p-0"
              >
                <MediaObjectNested />
              </PreviewBlock>
          ...
          <section>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <PreviewBlock
                title="Simple"
                description="Separates two adjacent content regions."
                code={dividerSimpleSource}
                previewClassName="p-0"
              >
                <DividerSimple />
              </PreviewBlock>
              <PreviewBlock
                title="With label"
                description="Useful for auth flows and alternative paths."
                code={dividerWithLabelSource}
                previewClassName="p-0"
              >
                <DividerWithLabel />
              </PreviewBlock>
              <PreviewBlock
                title="With title"
                description="Elevates a divider into a section transition."
                code={dividerWithTitleSource}
                previewClassName="p-0"
              >
                <DividerWithTitle />
              </PreviewBlock>
              <PreviewBlock
                title="With button"
                description="Places an action directly inside the divider."
                code={dividerWithButtonSource}
                previewClassName="p-0"
              >
                <DividerWithButton />
              </PreviewBlock>
              <PreviewBlock
                title="With toolbar"
                description="Combines count, controls, and a content boundary."
                code={dividerWithToolbarSource}
                previewClassName="p-0"
          ...
          <section>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <PreviewBlock
                ...
                description="The standard full-page content wrapper."
                code={containerConstrainedSource}
                previewClassName="p-0"
              >
                <ContainerConstrained />
              </PreviewBlock>
              <PreviewBlock
                title="Narrow constrained"
                description="A focused single-column container."
                code={containerNarrowSource}
                previewClassName="p-0"
              >
                <ContainerNarrow />
              </PreviewBlock>
              <PreviewBlock
                ...
                description="Edge-to-edge on small screens, padded on larger ones."
                code={containerFullWidthOnMobileSource}
                previewClassName="p-0"
              >
          ...
          <section>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <PreviewBlock
                ...
                description="A straightforward vertical list."
                code={listContainerSimpleSource}
                previewClassName="p-6"
              >
                <ListContainerSimple />
              </PreviewBlock>
              <PreviewBlock
                ...
                description="A list inside a bordered panel."
                code={listContainerCardSource}
                previewClassName="p-6"
              >
                <ListContainerCard />
              </PreviewBlock>
              <PreviewBlock
                ...
                description="Each row stands alone as its own container."
                code={listContainerSeparateCardsSource}
                previewClassName="p-6"
              >

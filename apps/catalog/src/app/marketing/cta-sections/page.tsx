    ...
    <div className="mx-auto max-w-7xl px-8 py-10">
      <div className="mb-10">
        <div className="caption mb-4 flex items-center gap-1.5 text-taupe-400">
          ...
          <span>/</span>
          <span className="font-semibold text-taupe-900">CTA Sections</span>
        </div>
        <h1 className="display mb-2 text-taupe-900">CTA Sections</h1>
        ...
        <div className="mt-5 flex items-center gap-4 border-t border-taupe-100 pt-5">
          <p className="caption text-taupe-400">Conversion</p>
          <div className="h-3 w-px bg-taupe-100" />
          <p className="caption text-taupe-400">8 variants</p>
        </div>
      </div>
